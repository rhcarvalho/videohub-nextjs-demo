    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 group" data-blur={blur}>
        ...
        <p className="text-sm text-neutral-700 text-center sm:text-left">
          A basic React/Next.js app to demonstrate how to integrate VideoHub
          with Next.js. <br />
          Source code available at{" "}
          <a
            className="hover:underline hover:underline-offset-4"
            href="https://github.com/rhcarvalho/videohub-nextjs-demo"
            target="_blank"
            rel="noopener noreferrer"
          >
            rhcarvalho/videohub-nextjs-demo on GitHub
          </a>
          .
        </p>
